...
- Format & Channels / 格式与声道
  - Formats: E-AC3, TrueHD  
    **Note: TrueHD (MLP) decoding is not yet supported; implementation in progress.**  
    **说明：TrueHD（MLP）暂不支持，正在开发中。**
...
- Known Limitations / 已知限制
  ...
  - **TrueHD (MLP) decoding is currently not supported; feature under development.**  
    **TrueHD（MLP）解码目前尚不支持，功能开发中。**
